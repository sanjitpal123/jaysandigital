...
$newMain = @"
    ...
    <main class="flex-grow w-full bg-[#f8f9fc] relative overflow-hidden pb-20">
      ...
      <div class="max-w-[1400px] mx-4 xl:mx-auto mt-20 mb-16" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="group bg-white rounded-[30px] p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.1)] transition-all duration-300 transform hover:-translate-y-2 flex flex-col relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
            <div class="absolute -right-10 -top-10 w-40 h-40 bg-green-500 rounded-full opacity-5 group-hover:opacity-10 transition-opacity duration-300"></div>
            <div class="flex justify-between items-start mb-6 relative z-10">
              <div class="w-14 h-14 rounded-2xl bg-green-500/10 flex items-center justify-center text-green-600 text-2xl group-hover:scale-110 transition-transform">
                <i class="fas fa-folder-open"></i>
              </div>
              <span class="bg-[#18181b] text-white text-xs font-bold px-3 py-1 rounded-full"><i class="fas fa-lock text-secondary mr-1"></i> Enrolled Access</span>
            </div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-[#f8f9fc] hover:bg-green-600 text-green-600 hover:text-white font-bold py-3 px-6 rounded-xl transition-colors w-full border border-gray-200 hover:border-transparent relative z-10">
              <i class="fab fa-google-drive"></i> Open Drive Folder
            </a>
          </div>
          ...
          <div class="group bg-white rounded-[30px] p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.1)] transition-all duration-300 transform hover:-translate-y-2 flex flex-col relative overflow-hidden" data-aos="fade-up" data-aos-delay="300">
            <div class="absolute -right-10 -top-10 w-40 h-40 bg-purple-500 rounded-full opacity-5 group-hover:opacity-10 transition-opacity duration-300"></div>
            <div class="flex justify-between items-start mb-6 relative z-10">
              <div class="w-14 h-14 rounded-2xl bg-purple-500/10 flex items-center justify-center text-purple-600 text-2xl group-hover:scale-110 transition-transform">
                <i class="fas fa-folder-open"></i>
              </div>
              <span class="bg-[#18181b] text-white text-xs font-bold px-3 py-1 rounded-full"><i class="fas fa-lock text-secondary mr-1"></i> Enrolled Access</span>
            </div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-[#f8f9fc] hover:bg-purple-600 text-purple-600 hover:text-white font-bold py-3 px-6 rounded-xl transition-colors w-full border border-gray-200 hover:border-transparent relative z-10">
              <i class="fab fa-google-drive"></i> Open Drive Folder
            </a>
          </div>
          ...
          <!-- Folder 4 -->
          <div class="group bg-white rounded-[30px] p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.1)] transition-all duration-300 transform hover:-translate-y-2 flex flex-col relative overflow-hidden" data-aos="fade-up" data-aos-delay="100">
            <div class="absolute -right-10 -top-10 w-40 h-40 bg-blue-500 rounded-full opacity-5 group-hover:opacity-10 transition-opacity duration-300"></div>
            <div class="flex justify-between items-start mb-6 relative z-10">
              <div class="w-14 h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-600 text-2xl group-hover:scale-110 transition-transform">
                <i class="fas fa-folder-open"></i>
              </div>
              <span class="bg-[#18181b] text-white text-xs font-bold px-3 py-1 rounded-full"><i class="fas fa-lock text-secondary mr-1"></i> Enrolled Access</span>
            </div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-[#f8f9fc] hover:bg-blue-600 text-blue-600 hover:text-white font-bold py-3 px-6 rounded-xl transition-colors w-full border border-gray-200 hover:border-transparent relative z-10">
              <i class="fab fa-google-drive"></i> Open Drive Folder
            </a>
          </div>
          ...
          <!-- Folder 5 -->
          <div class="group bg-white rounded-[30px] p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.1)] transition-all duration-300 transform hover:-translate-y-2 flex flex-col relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
            <div class="absolute -right-10 -top-10 w-40 h-40 bg-orange-500 rounded-full opacity-5 group-hover:opacity-10 transition-opacity duration-300"></div>
            <div class="flex justify-between items-start mb-6 relative z-10">
              <div class="w-14 h-14 rounded-2xl bg-orange-500/10 flex items-center justify-center text-orange-600 text-2xl group-hover:scale-110 transition-transform">
                <i class="fas fa-folder-open"></i>
              </div>
              <span class="bg-[#18181b] text-white text-xs font-bold px-3 py-1 rounded-full"><i class="fas fa-lock text-secondary mr-1"></i> Enrolled Access</span>
            </div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-[#f8f9fc] hover:bg-orange-600 text-orange-600 hover:text-white font-bold py-3 px-6 rounded-xl transition-colors w-full border border-gray-200 hover:border-transparent relative z-10">
              <i class="fab fa-google-drive"></i> Open Drive Folder
            </a>
          </div>
          ...
          <!-- Folder 6 -->
          <div class="group bg-white rounded-[30px] p-8 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgb(0,0,0,0.1)] transition-all duration-300 transform hover:-translate-y-2 flex flex-col relative overflow-hidden" data-aos="fade-up" data-aos-delay="300">
            <div class="absolute -right-10 -top-10 w-40 h-40 bg-red-500 rounded-full opacity-5 group-hover:opacity-10 transition-opacity duration-300"></div>
            <div class="flex justify-between items-start mb-6 relative z-10">
              <div class="w-14 h-14 rounded-2xl bg-red-500/10 flex items-center justify-center text-red-600 text-2xl group-hover:scale-110 transition-transform">
                <i class="fas fa-folder-open"></i>
              </div>
              <span class="bg-[#18181b] text-white text-xs font-bold px-3 py-1 rounded-full"><i class="fas fa-lock text-secondary mr-1"></i> Enrolled Access</span>
            </div>
            ...
            <a href="#" class="inline-flex items-center justify-center gap-2 bg-[#f8f9fc] hover:bg-red-600 text-red-600 hover:text-white font-bold py-3 px-6 rounded-xl transition-colors w-full border border-gray-200 hover:border-transparent relative z-10">
              <i class="fab fa-google-drive"></i> Open Drive Folder
            </a>
          </div>
      ...
      <div class="w-full max-w-[1400px] mx-4 xl:mx-auto mt-20 mb-10 flex flex-col lg:flex-row gap-0 rounded-[40px] overflow-hidden shadow-2xl" data-aos="fade-up">
        ...
        <div class="lg:w-1/2 bg-white flex items-center justify-center p-12 border-t lg:border-t-0 lg:border-l border-gray-200">
           <!-- Placeholder for an image of a community gathering or chat illustration -->
           <div class="w-full h-full min-h-[300px] rounded-[30px] bg-[#f8f9fc] border-4 border-dashed border-gray-200 flex items-center justify-center flex-col text-gray-400">
              <i class="fas fa-users text-6xl mb-4 text-[#0A2E6F]/30"></i>
              <span class="font-bold text-xl text-[#0A2E6F]/50">Community Network</span>
           </div>
        </div>
      </div>
