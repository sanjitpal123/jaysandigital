  ...
  <body class="bg-[#052B71] min-h-screen flex flex-col font-sans text-gray-800 overflow-x-hidden w-full selection:bg-secondary selection:text-primary">
    ...
    <nav class="bg-white/5 backdrop-blur-md border-b border-white/10 py-4 px-6 md:px-10 flex justify-between items-center sticky top-0 z-50 transition-all duration-300">
      ...
      <div class="hidden lg:block">
        <a href="#enroll" class="bg-secondary text-primary hover:bg-white font-bold py-2.5 px-6 rounded-full flex items-center justify-center gap-2 transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(238,164,12,0.4)]">
          Start Learning <i class="fas fa-arrow-right text-sm"></i>
        </a>
      </div>
    ...
    <div id="mobileMenu" class="fixed inset-0 bg-[#052B71]/95 backdrop-blur-xl z-[100] hidden flex-col items-center justify-center opacity-0 transition-opacity duration-300">
      ...
      <div class="flex flex-col items-center gap-8 text-white font-bold text-2xl font-display">
        ...
        <a href="#enroll" onclick="closeMobileMenu()" class="mt-4 bg-secondary text-primary py-3 px-8 rounded-full text-lg">Enroll Now</a>
      </div>
    </div>

    <!-- Hero Section -->
    <main class="relative w-full min-h-[90vh] flex items-center justify-center py-12 lg:py-0 overflow-hidden">
      ...
      <div class="w-[calc(100%-2rem)] max-w-[1400px] mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div class="lg:col-span-7 flex flex-col items-start text-left" data-aos="fade-up">
          <div class="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-white px-4 py-2 rounded-full mb-8 backdrop-blur-sm">
            ...
            <span class="font-bold text-xs tracking-wider uppercase">Live in Odia Language</span>
          </div>
          
          <h1 class="text-5xl md:text-6xl lg:text-[76px] font-display font-black text-white leading-[1.1] mb-6 tracking-tight">
            Master <span class="text-gradient animate-text-shimmer">Digital Skills</span><br />
            That Pay You Back.
          </h1>
          
          <p class="text-lg md:text-xl text-white/70 font-medium mb-10 max-w-2xl leading-relaxed">
            Practical AI, Digital Marketing, and Design for working professionals and ambitious learners — taught step-by-step in native Odia.
          </p>

          <div class="flex flex-wrap gap-4 mb-12">
            <div class="flex items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
              <div class="w-10 h-10 rounded-full bg-secondary/20 flex items-center justify-center text-secondary"><i class="fas fa-video"></i></div>
              <div class="text-white"><div class="font-bold">Live Classes</div><div class="text-xs text-white/50">Interactive sessions</div></div>
            </div>
            <div class="flex items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
              <div class="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400"><i class="fas fa-briefcase"></i></div>
              <div class="text-white"><div class="font-bold">Placement</div><div class="text-xs text-white/50">Career support</div></div>
            </div>
            <div class="flex items-center gap-3 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
              <div class="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center text-green-400"><i class="fas fa-language"></i></div>
              <div class="text-white"><div class="font-bold">100% Odia</div><div class="text-xs text-white/50">Learn comfortably</div></div>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4">
            <div class="flex -space-x-4">
              <img src="https://ui-avatars.com/api/?name=A+B&background=fff&color=052B71" class="w-12 h-12 rounded-full border-2 border-[#052B71]" alt="User">
              <img src="https://ui-avatars.com/api/?name=S+P&background=EEA40C&color=fff" class="w-12 h-12 rounded-full border-2 border-[#052B71]" alt="User">
              <img src="https://ui-avatars.com/api/?name=M+K&background=fff&color=052B71" class="w-12 h-12 rounded-full border-2 border-[#052B71]" alt="User">
              <div class="w-12 h-12 rounded-full border-2 border-[#052B71] bg-white/10 backdrop-blur-sm flex items-center justify-center text-white text-xs font-bold">+200</div>
            </div>
            <div class="text-white/80 text-sm font-medium">
              Join <span class="text-white font-bold">200+</span> successful students.
        ...
        <div id="enroll" class="lg:col-span-5 w-full max-w-md mx-auto lg:max-w-none mt-10 lg:mt-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="glass-panel rounded-[2rem] p-8 md:p-10 relative overflow-hidden">
            ...
            <div class="text-center mb-8 relative z-10">
              <h2 class="text-3xl font-display font-black text-white mb-2">Claim Your Spot</h2>
              <p class="text-white/60 text-sm">Book a free strategy session today.</p>
            </div>
            ...
            <form class="space-y-5 relative z-10">
              <div class="relative">
                ...
                <input type="text" placeholder="Full Name" class="w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-secondary focus:bg-white/10 transition-all font-medium">
              </div>
              ...
              <div class="relative">
                ...
                <input type="tel" placeholder="WhatsApp Number" class="w-full pl-11 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-secondary focus:bg-white/10 transition-all font-medium">
              </div>
              ...
              <div class="relative">
                ...
                <select class="w-full pl-11 pr-4 py-3.5 bg-[#0a3582] border border-white/10 rounded-xl text-white focus:outline-none focus:border-secondary transition-all font-medium appearance-none">
                  <option value="" disabled selected>Select Program...</option>
                  <option value="digital">Digital Marketing</option>
                  <option value="ai">AI Tools Mastery</option>
              ...
              <button type="button" onclick="alert('Form Submitted successfully!')" class="w-full bg-gradient-to-r from-secondary to-[#f5d101] text-primary font-black py-4 rounded-xl shadow-[0_0_20px_rgba(238,164,12,0.3)] hover:shadow-[0_0_30px_rgba(238,164,12,0.6)] hover:-translate-y-1 transition-all duration-300 text-lg uppercase tracking-wider mt-2">
                Secure My Spot
              </button>
            </form>
            <div class="mt-6 text-center text-xs text-white/40 flex justify-center items-center gap-2 relative z-10">
              <i class="fas fa-lock"></i> 100% Secure & Confidential
            </div>
          </div>
        </div>
    ...
    <section class="py-24 bg-white relative z-20 rounded-t-[3rem] -mt-10 border-t-4 border-secondary">
      <div class="w-[calc(100%-2rem)] max-w-[1200px] mx-auto">
        ...
        <div class="text-center mb-16" data-aos="fade-up">
          <h2 class="text-4xl md:text-5xl font-display font-black text-primary mb-4">Why JaySan <span class="text-secondary">Academy?</span></h2>
          <p class="text-gray-500 text-lg max-w-2xl mx-auto font-medium">Built for execution. We don't just teach theory; we build real-world digital portfolios.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px]">
          ...
          <div class="md:col-span-2 bg-[#f8f9fc] rounded-3xl p-8 md:p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 group overflow-hidden relative flex flex-col justify-center" data-aos="fade-up">
            ...
            <div class="w-14 h-14 rounded-2xl bg-primary text-white flex items-center justify-center text-2xl mb-6 shadow-lg group-hover:scale-110 transition-transform relative z-10"><i class="fas fa-project-diagram"></i></div>
            <h3 class="text-2xl font-bold text-primary mb-3 relative z-10">100% Practical Implementation</h3>
            <p class="text-gray-600 font-medium max-w-md relative z-10">From day one, you run real ad campaigns, design actual graphics, and build working sales funnels. No useless theory.</p>
          </div>
          ...
          <div class="bg-primary rounded-3xl p-8 border border-[#0a3a99] hover:shadow-[0_10px_30px_rgba(5,43,113,0.3)] transition-all duration-300 group relative overflow-hidden flex flex-col justify-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <h3 class="text-xl font-bold text-white mb-2 relative z-10">Native Odia</h3>
            <p class="text-white/70 font-medium text-sm relative z-10">Master complex strategies easily in your own language.</p>
          </div>
          ...
          <div class="bg-secondary rounded-3xl p-8 border border-yellow-400 hover:shadow-[0_10px_30px_rgba(238,164,12,0.4)] transition-all duration-300 group flex flex-col justify-center" data-aos="fade-up">
            <div class="w-14 h-14 rounded-2xl bg-white/20 text-primary flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform"><i class="fas fa-handshake"></i></div>
            <h3 class="text-xl font-bold text-primary mb-2">Job Support</h3>
            <p class="text-primary/80 font-medium text-sm">Dedicated placement assistance and freelance gig guidance.</p>
          </div>
    ...
    <section class="py-20 bg-[#f4f7fb] border-y border-gray-200 overflow-hidden relative">
      <div class="text-center mb-12" data-aos="fade-up">
        <h2 class="text-3xl md:text-4xl font-display font-black text-primary mb-4">Student <span class="text-secondary">Success</span></h2>
      </div>

      <!-- Marquee Container -->
      <div class="relative flex overflow-x-hidden w-full group">
        <!-- Fade Edges -->
        <div class="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-[#f4f7fb] to-transparent z-10"></div>
        <div class="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-[#f4f7fb] to-transparent z-10"></div>
        ...
        <div class="flex animate-marquee group-hover:[animation-play-state:paused] gap-6 px-3">
          <!-- Card 1 -->
          <div class="glass-card w-[350px] shrink-0 p-8 rounded-3xl shadow-sm border border-gray-200">
            ...
            <p class="text-gray-700 italic font-medium mb-6">"Learning Digital Marketing in Odia made everything so much easier to understand. Started my freelancing journey!"</p>
            <div class="flex items-center gap-4">
              <img src="https://ui-avatars.com/api/?name=Rakesh+S&background=052B71&color=fff" class="w-10 h-10 rounded-full" alt="User">
              <div><div class="font-bold text-primary text-sm">Rakesh S.</div><div class="text-xs text-gray-500">Freelancer</div></div>
            </div>
          </div>
          <!-- Card 2 -->
          <div class="glass-card w-[350px] shrink-0 p-8 rounded-3xl shadow-sm border border-gray-200">
            <div class="flex gap-1 text-secondary text-sm mb-4"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
            <p class="text-gray-700 italic font-medium mb-6">"The AI Tools Mastery course is a game-changer! I save hours of work every week. The mentors are incredibly supportive."</p>
            <div class="flex items-center gap-4">
              <img src="https://ui-avatars.com/api/?name=Smriti+M&background=EEA40C&color=fff" class="w-10 h-10 rounded-full" alt="User">
              <div><div class="font-bold text-primary text-sm">Smriti M.</div><div class="text-xs text-gray-500">Marketer</div></div>
            </div>
          </div>
          <!-- Card 3 -->
          <div class="glass-card w-[350px] shrink-0 p-8 rounded-3xl shadow-sm border border-gray-200">
            <div class="flex gap-1 text-secondary text-sm mb-4"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
            <p class="text-gray-700 italic font-medium mb-6">"From zero knowledge to running successful Meta ads. The practical assignments are the best part of JaySan Academy."</p>
            <div class="flex items-center gap-4">
              <img src="https://ui-avatars.com/api/?name=Bikash+M&background=052B71&color=fff" class="w-10 h-10 rounded-full" alt="User">
              <div><div class="font-bold text-primary text-sm">Bikash M.</div><div class="text-xs text-gray-500">Business Owner</div></div>
            </div>
          </div>
        </div>
...
print("Updated landing.html with new design.")
