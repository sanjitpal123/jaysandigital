...
$newMain = @"
    ...
    <main class="flex-grow w-full bg-[#f8f9fc] relative overflow-hidden pb-10">
      ...
      <!-- About Us Hero -->
      <div
        class="w-full max-w-[1400px] mx-4 xl:mx-auto my-4 lg:my-8 relative flex flex-col lg:flex-row items-stretch min-h-[500px] border-[4px] border-[#18181b] rounded-[40px] overflow-hidden bg-[#f5f5f5]"
        data-aos="fade-up"
      >
        <!-- Left Content Area -->
        <div class="w-full lg:w-[55%] p-10 md:p-16 flex flex-col justify-center relative z-10 text-left">
          ...
          <h2 class="text-2xl md:text-3xl font-bold text-primary mb-6 max-w-3xl">
            Empowering the next generation of digital leaders in Odisha.
          </h2>
          <p class="text-primary/80 font-medium text-lg leading-relaxed max-w-2xl">
        ...
        <!-- Right Image Area -->
        <div class="w-full lg:w-[45%] bg-[#0A2E6F] relative overflow-hidden min-h-[300px] lg:min-h-full">
          <img src="assets/images/hero_img.webp" alt="JaySan Academy mentors and team" class="w-full h-full object-cover opacity-90 mix-blend-luminosity">
          <div class="absolute inset-0 bg-gradient-to-t from-[#0A2E6F] to-transparent opacity-80"></div>
          <div class="absolute bottom-6 left-6 text-white font-bold text-xl drop-shadow-md">JaySan Academy mentors and team</div>
        </div>
      </div>
      ...
      <div class="w-full max-w-[1400px] mx-4 xl:mx-auto my-20" data-aos="fade-up">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="bg-white p-8 rounded-[30px] border-b-[6px] border-secondary shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div class="w-16 h-16 bg-[#fceccf] rounded-2xl flex items-center justify-center text-secondary text-3xl font-black mb-6">01</div>
          ...
          <div class="bg-white p-8 rounded-[30px] border-b-[6px] border-primary shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary text-3xl font-black mb-6">02</div>
          ...
          <div class="bg-white p-8 rounded-[30px] border-b-[6px] border-secondary shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div class="w-16 h-16 bg-[#fceccf] rounded-2xl flex items-center justify-center text-secondary text-3xl font-black mb-6">03</div>
          ...
          <div class="bg-white p-8 rounded-[30px] border-b-[6px] border-primary shadow-sm hover:-translate-y-2 transition-transform duration-300">
            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary text-3xl font-black mb-6">04</div>
      ...
      <div class="w-full max-w-[1400px] mx-4 xl:mx-auto my-20 p-10 lg:p-16 border-[4px] border-[#18181b] rounded-[40px] bg-white relative overflow-hidden" data-aos="fade-up">
        ...
        <div class="text-center mb-16 relative z-10">
          <p class="text-secondary font-bold tracking-widest uppercase mb-4">From a local initiative to Odisha's leading digital academy</p>
        ...
        <div class="max-w-[800px] mx-auto relative z-10">
          ...
          <div class="relative flex flex-col md:flex-row items-start md:items-center justify-between group">
            ...
            <div class="w-full md:w-5/12 text-left pl-16 md:pl-12">
              ...
              <h3 class="text-xl font-bold text-primary mb-2">10,000+ Students & a Complete 57-Day Curriculum</h3>
              <p class="text-primary/70 text-sm leading-relaxed font-medium">Launched our full 19-module flagship program spanning digital foundations, AI, design, video, performance marketing and career placement — continuing our mission to make Odisha the digital talent hub of India.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Call to Action -->
      <div class="w-full max-w-[1400px] mx-4 xl:mx-auto my-20 p-10 lg:p-16 border-[4px] border-[#18181b] rounded-[40px] bg-[#0A2E6F] relative overflow-hidden text-center" data-aos="fade-up">
        <h2 class="text-4xl md:text-5xl font-black text-white mb-6 leading-tight max-w-3xl mx-auto">
          Ready to upgrade your skills?
        </h2>
        <p class="text-white/80 font-medium text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-10">
          Join thousands of successful students and start learning the skills that pay you back every day.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <button class="bg-secondary text-primary font-bold py-4 px-8 rounded-full hover:-translate-y-1 transition-transform border-[3px] border-[#18181b] shadow-[4px_4px_0_0_#18181b] flex items-center gap-2 w-full sm:w-auto justify-center">
            <i class="fas fa-video"></i> Join Free Webinar
          </button>
          <button class="bg-white text-primary font-bold py-4 px-8 rounded-full hover:-translate-y-1 transition-transform border-[3px] border-[#18181b] shadow-[4px_4px_0_0_#18181b] flex items-center gap-2 w-full sm:w-auto justify-center">
